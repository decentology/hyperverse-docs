...
Give the users the ability to buy or sell SimpleNFTs using $FLOW tokens.
...
- [SimpleNFT Marketplace](https://www.youtube.com/watch?v=h0naY00Jnpk) - Check out this video to understand how to use the SimpleNFT Marketplace module.
