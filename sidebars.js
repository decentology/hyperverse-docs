const sidebars = {
  ...
  basics: [
    ...
    },
    {
      ...
      label: "Build a dApp",
      items: [
        { type: "doc", label: "Overview", id: "build/introduction" },
        ...
        },
        {
          ...
          items: [
            { type: "doc", label: "Overview", id: "build/dapp/overview" },
            {
              type: "doc",
              label: "Run your dApp",
              id: "build/dapp/run-your-dapp",
            },
            {
              type: "doc",
              label: "Modify the Client",
              id: "build/dapp/modify-the-client",
            },
            {
              type: "doc",
              label: "Call Functions",
              id: "build/dapp/call-functions",
            },
          ],
        },
      ],
      ...
      items: [
        { type: "doc", label: "Overview", id: "learn/blockchain/overview" },
        {
          ...
          items: [
            {
              type: "doc",
              label: "Welcome to Algorand",
              id: "learn/blockchain/algorand/welcome-to-algorand",
            },
          ],
        },
        {
          ...
          items: [
            {
              type: "doc",
              label: "Welcome to Conflux",
              id: "learn/blockchain/conflux/welcome-to-conflux",
            },
          ],
        },
        {
          ...
          items: [
            {
              type: "doc",
              label: "Welcome to Ethereum",
              id: "learn/blockchain/ethereum/welcome-to-ethereum",
            },
          ],
        },
        {
          ...
          items: [
            {
              ...
              id: "learn/blockchain/flow/welcome-to-flow",
            },
            {
              type: "doc",
              label: "Overview",
              id: "learn/blockchain/flow/overview",
            },
            {
              type: "category",
              label: "Basic",
              items: [
                {
                  type: "doc",
                  label: "Overview",
                  id: "learn/blockchain/flow/basic/overview",
                },
                {
                  type: "doc",
                  label: "Environment",
                  id: "learn/blockchain/flow/basic/environment-setup",
                },
                {
                  type: "doc",
                  label: "Cadence Syntax",
                  id: "learn/blockchain/flow/basic/cadence-syntax",
                },
                {
                  type: "doc",
                  label: "Cadence Functions",
                  id: "learn/blockchain/flow/basic/cadence-functions",
                },
                {
                  type: "doc",
                  label: "Playing with Cadence",
                  id: "learn/blockchain/flow/basic/playing-with-cadence",
                },
                {
                  type: "doc",
                  label: "Flow Playground",
                  id: "learn/blockchain/flow/basic/flow-playground",
                },
                {
                  type: "doc",
                  label: "Flow Emulator",
                  id: "learn/blockchain/flow/basic/flow-emulator",
                },
                {
                  type: "doc",
                  label: "Deploying Contracts",
                  id: "learn/blockchain/flow/basic/deploying-contracts",
                },
                {
                  type: "doc",
                  label: "Flow Client Library",
                  id: "learn/blockchain/flow/basic/flow-client-library",
                },
                {
                  type: "doc",
                  label: "Flow NFT Marketplace",
                  id: "learn/blockchain/flow/basic/flow-nft-marketplace",
                },
                {
                  type: "doc",
                  label: "Review",
                  id: "learn/blockchain/flow/basic/lesson-review",
                },
              ],
            },
            {
              ...
              items: [
                {
                  type: "doc",
                  label: "Overview",
                  id: "learn/blockchain/flow/intermediate/overview",
                },
                {
                  type: "doc",
                  label: "Access Control",
                  id: "learn/blockchain/flow/intermediate/access-control",
                },
                {
                  type: "doc",
                  label: "Contract Interfaces",
                  id: "learn/blockchain/flow/intermediate/contract-interfaces",
                },
                {
                  type: "doc",
                  label: "Fast Floward Foundation",
                  id: "learn/blockchain/flow/intermediate/fast-floward-foundation",
                },
                {
                  type: "doc",
                  label: "DappStarter Architecture",
                  id: "learn/blockchain/flow/intermediate/dappstarter-architecture",
                },
                {
                  type: "doc",
                  label: "Kitty Items Contract",
                  id: "learn/blockchain/flow/intermediate/kitty-items-contract",
                },
                {
                  type: "doc",
                  label: "Intro to Dapplib",
                  id: "learn/blockchain/flow/intermediate/dapplib-transactions-scripts",
                },
                {
                  type: "doc",
                  label: "DappStarter Client",
                  id: "learn/blockchain/flow/intermediate/dappstarter-client",
                },
                {
                  type: "doc",
                  label: "DappStarter Tests",
                  id: "learn/blockchain/flow/intermediate/dappstarter-tests",
                },
                {
                  type: "doc",
                  label: "Final Quest",
                  id: "learn/blockchain/flow/intermediate/day-5-quest",
                },
                {
                  type: "doc",
                  label: "Review",
                  id: "learn/blockchain/flow/intermediate/lesson-review",
                },
              ],
            },
            {
              ...
              items: [
                {
                  type: "doc",
                  label: "Overview",
                  id: "learn/blockchain/flow/advanced/overview",
                },
                {
                  type: "doc",
                  label: "Composability",
                  id: "learn/blockchain/flow/advanced/smart-contract-composability",
                },
                {
                  type: "doc",
                  label: "Day 2 Office Hours",
                  id: "learn/blockchain/flow/advanced/day-2-office-hours",
                },
                {
                  type: "doc",
                  label: "Day 3 Office Hours",
                  id: "learn/blockchain/flow/advanced/day-3-office-hours",
                },
                {
                  type: "doc",
                  label: "Day 4 Office Hours",
                  id: "learn/blockchain/flow/advanced/day-4-office-hours",
                },
              ],
            },
          ],
        },
        {
          ...
          items: [
            {
              type: "doc",
              label: "Welcome to Near",
              id: "learn/blockchain/near/welcome-to-near",
            },
          ],
        },
        {
          ...
          items: [
            {
              type: "doc",
              label: "Welcome to Polygon",
              id: "learn/blockchain/polygon/welcome-to-polygon",
            },
          ],
        },
        {
          ...
          items: [
            {
              type: "doc",
              label: "Welcome to Solana",
              id: "learn/blockchain/solana/welcome-to-solana",
            },
          ],
        },
      ],
  ...
  //         id: "contribute/ambassadors/content-creators",
  //       },
  //       {
  //         type: "doc",
  //         label: "Technical Writers",
  //         id: "contribute/ambassadors/technical-writers",
  //       },
  //       {
  //         type: "doc",
  //         label: "Developers",
  //         id: "contribute/ambassadors/developers",
  //       },
  //     ],
  //   },
  //   {
  ...
  //         type: "doc",
  //         label: "Hackathons",
  //         id: "contribute/events/hackathons",
  //       },
  //       { type: "doc", label: "Webinars", id: "contribute/events/webinars" },
  //       {
  //         type: "doc",
  //         label: "Conferences",
  //         id: "contribute/events/conferences",
  //       },
  //     ],
  //   },
  ...
  //     id: "learn/blockchain/flow/code-of-conduct",
  //   },
  // ],
};
